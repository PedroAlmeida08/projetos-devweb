...
const ContactForm: React.FC = () => {
  // A referência para o formulário agora vive dentro deste componente
  const formRef = useRef<HTMLFormElement>(null);

  // O useEffect com a lógica de validação e tooltips também foi movido para cá
  useEffect(() => {
    ...
    Object.keys(fields).forEach((id) => {
      ...
      if (field) {
        const handleInvalid = () => field.setCustomValidity(fields[id]);
        const handleInput = () => field.setCustomValidity("");
