...
public class Apirestfulv1Application {
	...
	CommandLineRunner initDatabase(AutorRepository autorRepository,
		...
		return args -> {
			...
			Projeto proj4 = new Projeto("surveyForm.jpg", "Formulário de Pesquisa", "Um formulário de pesquisa responsivo criado com HTML e CSS.", "https://pedroalmeida08.github.io/HTML-SurveyForm/", LocalDate.of(2022, 1, 15), autor2, new BigDecimal("50.00"));
			Projeto proj5 = new Projeto("tributePage.jpg", "Página de Tributo", "Uma página de tributo simples e responsiva.", "https://pedroalmeida08.github.io/HTML-TributePage/", LocalDate.of(2022, 2, 20), autor2, new BigDecimal("45.90"));
